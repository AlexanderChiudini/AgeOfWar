...
public class CastleOdani extends Castle {
    
    private List<String> battleLine = new ArrayList<>();
    private List<String> castleFigures = new ArrayList<>();
    
    public CastleOdani(int points, String name, List<String> normalBattleLine, String daimyoBattleLine,List<String> castleFigures) {
    ...
    public void setCastleFigures(){
        castleFigures.add("image/cartas/cla_oda/carta_oda_odani.png");
