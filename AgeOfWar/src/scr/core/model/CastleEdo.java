...
public class CastleEdo extends Castle {
    
    private List<String> battleLine = new ArrayList<>();
    private List<String> castleFigures = new ArrayList<>();
    
    public CastleEdo(int points, String name, List<String> normalBattleLine, String daimyoBattleLine,List<String> castleFigures) {
    ...
    public void setCastleFigures(){
        castleFigures.add("image/cartas/cla_tokugawa/carta_tokugawa_edo.png");
